...
const UpdateProduct = () => {
  ...
  const { isLoading, ProductCategoryList, ProductCategoryListRequest } =
    productStore();

  const {
    userProductsUpdateRequest,
    productData,
    onChangeProductData,
    userSingleproductDetailRequest,
  } = UserStore();
                ...
                <div>
                  <div className="mb-3">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        onChangeProductData("title", e.target.value)
                      }
                      required
                    />
                  </div>
                  ...
                  <div className="md:grid grid-cols-2 gap-5">
                    <div className="mb-3">
                      ...
                      <input
                        ...
                        id="name"
                        onChange={(e) =>
                          onChangeProductData("price", e.target.value)
                        }
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-2 px-6 text-base  text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
                      />
                    </div>
                    <div className="mb-3">
                      ...
                      <input
                        ...
                        id="name"
                        onChange={(e) =>
                          onChangeProductData("edition", e.target.value)
                        }
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-2 px-6 text-base  text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
                      />
                    </div>
                  ...
                  <div className="md:grid grid-cols-3 gap-5">
                    <div className="mb-3">
                      ...
                      <div className="select__color css-b62m3t-container">
                        <span
                        ...
                        <div className=" css-h4xyy0-control">
                          <div className=" css-1d8n9bt">
                            <input
                              ...
                              onChange={(e) =>
                                onChangeProductData("district", e.target.value)
                              }
                              className="w-full rounded-md border border-[#e0e0e0] bg-white py-2 px-6 text-base  text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
                            />
                          </div>
                        ...
                        <div className=" css-h4xyy0-control">
                          <div className=" css-1d8n9bt">
                            <Select
                              ...
                              defaultValue={
                                ProductCategoryList && ProductCategoryList[0]
                              }
                      ...
                      <div className="flex gap-5">
                        <div className="flex flex-row">
                          <input
                            ...
                            onChange={(e) =>
                              onChangeProductData("condition", "used")
                            }
                            className="appearance-none mt-1 h-4 w-4 bg-gray-400 rounded-full  checked:bg-[#A855F7] transition-all duration-200 peer "
                          />
                          <div className="h-4 w-4 mt-1 absolute rounded-full pointer-events-none peer-checked:[#A855F7] peer-checked:border-2"></div>
                          <label
                            htmlFor="cb1"
                            className="flex cursor-pointer flex-col justify-center px-2 text-base  text-slate-500  select-none"
                          >
                            Used
                          </label>
                        </div>
                        <div className="flex flex-row">
                          <input
                            ...
                            onChange={(e) =>
                              onChangeProductData("condition", "new")
                            }
                            className="appearance-none mt-1 h-4 w-4 bg-gray-400 rounded-full  checked:bg-[#A855F7] transition-all duration-200 peer "
                          />
                          <div className="h-4 w-4 mt-1 absolute rounded-full pointer-events-none peer-checked:[#A855F7] peer-checked:border-2"></div>
                      ...
                      <div className="flex gap-5">
                        <div className="flex flex-row">
                          <input
                            ...
                            onChange={(e) =>
                              onChangeProductData("authenticity", "used")
                            }
                            className="appearance-none mt-1 h-4 w-4 bg-gray-400 rounded-full  checked:bg-[#A855F7] transition-all duration-200 peer "
                          />
                          <div className="h-4 w-4 mt-1 absolute rounded-full pointer-events-none peer-checked:[#A855F7] peer-checked:border-2"></div>
                        ...
                        <div className="flex flex-row">
                          <input
                            ...
                            onChange={(e) =>
                              onChangeProductData("authenticity", "new")
                            }
                            className="appearance-none mt-1 h-4 w-4 bg-gray-400 rounded-full  checked:bg-[#A855F7] transition-all duration-200 peer "
                          />
                          <div className="h-4 w-4 mt-1 absolute rounded-full pointer-events-none peer-checked:[#A855F7] peer-checked:border-2"></div>
                      ...
                      <div className="flex gap-5">
                        <div className="flex flex-row">
                          <input
                            ...
                            onChange={(e) =>
                              onChangeProductData("features", "physical")
                            }
                            className="appearance-none mt-1 h-4 w-4 bg-gray-400 rounded-full  checked:bg-[#A855F7] transition-all duration-200 peer "
                          />
                          <div className="h-4 w-4 mt-1 absolute rounded-full pointer-events-none peer-checked:[#A855F7] peer-checked:border-2"></div>
                        ...
                        <div className="flex flex-row">
                          <input
                            ...
                            onChange={(e) =>
                              onChangeProductData("features", "digital")
                            }
                            className="appearance-none mt-1 h-4 w-4 bg-gray-400 rounded-full  checked:bg-[#A855F7] transition-all duration-200 peer "
                          />
                          <div className="h-4 w-4 mt-1 absolute rounded-full pointer-events-none peer-checked:[#A855F7] peer-checked:border-2"></div>
                      ...
                      <div className="flex gap-5">
                        <div className="flex flex-row">
                          <input
                            ...
                            name="Negotiable"
                            onChange={(e) =>
                              onChangeProductData("negotiable", true)
                            }
                        ...
                        <div className="flex flex-row">
                          <input
                            ...
                            name="Negotiable"
                            onChange={(e) =>
                              onChangeProductData("negotiable", false)
                            }
                            checked={!productData.negotiable}
                            className="appearance-none mt-1 h-4 w-4 bg-gray-400 rounded-full  checked:bg-[#A855F7] transition-all duration-200 peer "
                          />
                  ...
                  <div className="md:grid grid-cols-2 gap-5">
                    <div className="mb-3">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          onChangeProductData("brand", e.target.value)
                        }
                        name="name"
                        id="name"
                    ...
                    <div className="mb-3">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          onChangeProductData("model", e.target.value)
                        }
                        name="name"
                        id="name"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-2 px-6 text-base  text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
                  ...
                  <div className="mb-3">
                    ...
                    >
                      Add Image
                      <span className="text-xs bg-[#ef4444]  py-0 px-2 ml-2 rounded-full text-white">
                        Max 200kb &amp; highest 5 Images
                      </span>
                    </label>
