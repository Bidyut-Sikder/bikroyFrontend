...
const SearchProductByCategory = () => {
    ...
    const { ProductSearchByCategory, ProductList, ProductListByKeywordRequest, ProductDetails, categoryName, location } = productStore();
    ...
    const onSubmitHandler = async () => {
        ...
        const filteredData = ProductList.filter(item => item.title.includes(searchData));

        await ProductSearchByCategory(filteredData)
    }
