            ...
            <div className="w-full max-w-sm">
                <form onSubmit={onsubmitHandler} className="bg-white shadow-lg rounded px-8 pt-6 pb-8 mb-4">
                    ...
                    <div className="mb-6">
                        ...
                        <input onChange={(e) => onChangeHandler('password', e.target.value)} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="password" type="password" placeholder="******************" />
