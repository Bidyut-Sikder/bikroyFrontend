...
const Header = () => {
  ...
  const { isLogin, profileDetails, userLogoutRequest, profileDetailsRequest } =
    UserStore();
  ...
  return (
    <div className=" bg-[#a855f7] pt-5 pb-3 md:py-4">
      <header className="  container mx-auto ">
          ...
          <div className="profile__section w-[480px] flex justify-end md:justify-between items-center">
            <span className="hidden md:flex items-end">
              <Link onClick={onClickHandler} to="/products">
                <button className="block py-2 px-8 rounded-full bg-[#FCD34D] font-semibold text-slate-700 hover:bg-[#fbbf24]">
                  <svg
                    stroke="currentColor"
                    fill="currentColor"
                    strokeWidth="0"
              ...
              {isLogin() ? (
                    ...
                    <div className="block rounded-full ">
                      {isLogin() ? (
                        <img
                          ...
                          src={
                            profileDetails.image ? profileDetails.image : image
                          }
                        />
                      ) : (
                        ""
                ...
                <>
                  <Link onClick={onClickHandler} to="/login">
                    <button className="ml-2 block py-2 px-8 rounded-full bg-[#FCD34D] font-semibold text-slate-700 hover:bg-[#fbbf24]">
                      Login
                    </button>
                  </Link>

                  <Link onClick={onClickHandler} to="/signup">
                    <button className="ml-2 block py-2 px-8 rounded-full bg-[#FCD34D] font-semibold text-slate-700 hover:bg-[#fbbf24]">
                      Signup
                    </button>
                  </Link>
        ...
        <div className="flex flex-col md:hidden sm:flex-row items-center sm:items-start justify-center sm:justify-start gap-6 sm:gap-8 mt-5 px-4 sm:px-0">
          <Link onClick={onClickHandler} to="/products">
            <button className="py-2 px-8 rounded-full bg-[#FCD34D] font-semibold text-slate-700 hover:bg-[#fbbf24]">
              <svg
                stroke="currentColor"
                fill="currentColor"
                strokeWidth="0"
          ...
          {isLogin() ? (
            ...
            <>
              <Link onClick={onClickHandler} to="/login">
                <button className="ml-2 py-2 px-8 rounded-full bg-[#FCD34D] font-semibold text-slate-700 hover:bg-[#fbbf24]">
                  Login
                </button>
              </Link>
