                    ...
                    <div className="profile__section w-[480px] flex justify-end md:justify-between items-center">
                        <span className="hidden md:flex items-end">
...

                            {
                                ...
                                </Link>) : (<Link onClick={onClickHandler} to="/login"><button
                                    className="ml-2 block py-2 px-8 rounded-full bg-[#FCD34D] font-semibold text-slate-700 hover:bg-[#fbbf24]"><svg
                                        stroke="currentColor" fill="currentColor" strokeWidth="0"
                                        viewBox="0 0 24 24" className="inline" height="1em" width="1em"
                                        xmlns="http://www.w3.org/2000/svg">
                            ...
                            {/* <Link onClick={onClickHandler} to="/products"><button
                                className="block py-2 px-8 rounded-full bg-[#FCD34D] font-semibold text-slate-700 hover:bg-[#fbbf24]">
                                    <svg
                                    stroke="currentColor" fill="currentColor" strokeWidth="0"
                                    viewBox="0 0 24 24" className="inline" height="1em" width="1em"
                                    xmlns="http://www.w3.org/2000/svg">
                        ...
                        {/* <Link to="/signup"
                            className="hidden  md:block py-2 px-8 rounded-full bg-[#FCD34D] font-semibold text-slate-700 hover:bg-[#fbbf24]"
                        ...
                        {/* {
                            isLogin() ? (
                                <Link to={''}
                                    className="hidden md:block text-slate-700 font-semibold p-2 transition-primary btn-secondary"
                                ><svg stroke="currentColor" fill="currentColor" strokeWidth="0"
                                    viewBox="0 0 640 512" className="inline-block " height="1em" width="1em"
                                    xmlns="http://www.w3.org/2000/svg">
                                        <path
