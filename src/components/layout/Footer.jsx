    ...
    <div className="footer bg-[#192132] py-8 px-2">
      ...
      <div className="container mx-auto mb-5">
        ...
        <div className="footer__section grid md:grid-cols-3 gap-10">
            ...
            <div className="logo__section">
              <div className="logo__section w-80 flex justify-between items-center mb-4">
                <a href="/"><img
                  ...
                  alt="" className="inline-block " /></a>
              </div>
              <div>
                <p className="text-slate-300 text-sm">This website Build ReactJs,
                  ExpressJS, NodeJS, MongoDB &amp; Tailwind CSS. If you have any
                  question you can visit 
                  <strong className="text-[#c084fc]">
                    <a target="blank" href=" https://portfolio-blush-tau-45.vercel.app"> bidyutsikder.com</a> </strong>
                   or <br />
                   email: bidyutsikder2001@gmail.com</p>
              </div>
            </div>
          </div>
          ...
          <div className="item">
            <div className="logo__section">
              <h3 className="text-slate-100 text-lg font-semibold">Important Link</h3>
              <ul className="mt-3">
                <li className="text-slate-300 text-sm"><a className="inline-block py-1" href="/"><svg
                  stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 16 16"
                  className="inline text-[#FBBF24] mb-1 mr-2" height="1em" width="1em"
                  xmlns="http://www.w3.org/2000/svg">
                  <path
                    d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0zM4.5 7.5a.5.5 0 0 0 0 1h5.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3a.5.5 0 0 0 0-.708l-3-3a.5.5 0 1 0-.708.708L10.293 7.5H4.5z">
                  </path>
                </svg>Home</a></li>
                <li className="text-slate-300 text-sm"><a className="inline-block py-1" href="/all-ads/1"><svg
                  stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 16 16"
                  className="inline text-[#FBBF24] mb-1 mr-2" height="1em" width="1em"
                  xmlns="http://www.w3.org/2000/svg">
                  <path
                ...
                <li className="text-slate-300 text-sm"><a className="inline-block py-1" href="/profile"><svg
                  stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 16 16"
                  className="inline text-[#FBBF24] mb-1 mr-2" height="1em" width="1em"
                  xmlns="http://www.w3.org/2000/svg">
                  <path
          ...
          <div className="item">
            ...
            <div className="logo__section">
              ...
              <p className="text-slate-300 text-sm mt-3">Sign up and receive the latest
                tips via email.
              </p>
              <label className="block mt-2">
                ...
                className="btn-primary inline-block py-2 px-8 rounded-lg bg-[#7e22ce] text-slate-200 hover:text-slate-50">Subscribe</a>
      ...
      <div className="footer__copywriter">
        <div className="container mx-auto">
          <div className="flex justify-center items-center mt-5">
            <p className="text-slate-300 text-sm">© 2022 Buy and Sell. Design with by<a target="blank" href="https://portfolio-blush-tau-45.vercel.app"
              className="text-[#c084fc] pl-2">Bidyut Sikder</a>
            </p>
          </div>
        </div>
      </div>
