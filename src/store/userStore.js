...
const UserStore = create((set) => ({
    ...
    userSingleproductDetailRequest: async (productID) => {
        ...
        const res = await axios.get(`${BASEURL}/api/v1/UserSingleProductDetail/${productID}`,{ headers: { token:token }})
    ...
    userProductsUpdateRequest: async (productID, reqBody) => {
        ...
        const res = await axios.post(`${BASEURL}/api/v1/UserProductUpdate/${productID}`, reqBody,{ headers: { token:token }})
    ...
    ProductCreateRequest: async (formData) => {
        ...
        set({ isLoading: true })
        const res = await axios.post(`${BASEURL}/api/v1/ProductCreate/`, formData,{ headers: { token:token }})
    ...
    userLoginRequest: async (email, password) => {
        ...
        let res = await axios.get(`${BASEURL}/api/v1/UserLogin/${email}/${password}`,{ headers: { token:token }})
    ...
    userProductsRequest: async () => {
        ...
        const res = await axios.get(`${BASEURL}/api/v1/UserProducts`,{ headers: { token:token }})
    ...
    profileDetailsRequest: async () => {
        ...
        const res = await axios.get(`${BASEURL}/api/v1/ReadUserProfile`,{ headers: { token:token }})
    ...
    profileUpdateRequest: async (postBody) => {
        const res = await axios.post(`${BASEURL}/api/v1/UpdateUserProfile`, postBody, { headers: { 'Content-Type': 'multipart/form-data',token:token } })
    ...
    userLogoutRequest: async () => {
        ...
        let res = await axios.get(`${BASEURL}/api/v1/UserLogout`, { headers: { token:token } })
