...
const AdminStore = create((set) => ({
    ...
    adminLoginRequest: async (email, password) => {
        ...
        let res = await axios.get(`/api/v1/AdminLogin/${email}/${password}`)
    ...
    adminDetailsRequest: async () => {
        ...
        const res = await axios.get(`/api/v1/ReadAdmin`)
        //console.log(res)
        if (res['data']['data']) {
    ...
    adminProductsRequest: async () => {
        ...
        const res = await axios.get(`/api/v1/AdminProduct`)
    ...
    adminProductUpdateRequest: async (id, reqData) => {
        ...
        const res = await axios.post(`/api/v1/AdminProductUpdate/${id}`, reqData)
    ...
    adminAdminLogoutRequest: async () => {
        ...
        const res = await axios.get(`/api/v1/AdminLogout`)
