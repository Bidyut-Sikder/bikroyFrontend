...
const ProductPageByMutipleSearchData = () => {
    const { district, upozila, categoryID } = useParams()
    const { ProductsRequestByTag, ProductCategoryListRequest, ProductList } = productStore()
    ...
    useEffect(() => {
        (async () => {
            ...
            await ProductsRequestByTag(district, upozila, categoryID)
...
export default ProductPageByMutipleSearchData;
